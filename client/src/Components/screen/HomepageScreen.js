...
if(textSearchStranger.length >= 9) {
    ...
    const handleCreateRoom = useCallback(async () => {
        ...
        setDoc(doc(database, 'Rooms', r), {
            ...
            owner: id,
            type: 'group',
            urlImage: 'https://res.cloudinary.com/dljwo91tl/image/upload/v1712679597/samples/dessert-on-a-plate.jpg',
        ...
        <div className="modal fade" id="UserInfoModal">
                <div className="modal-dialog modal-dialog-centered">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div style={{position:'relative', backgroundImage:'url("https://res.cloudinary.com/dljwo91tl/image/upload/v1712679595/samples/coffee.jpg")', backgroundSize:'cover', backgroundRepeat:'no-repeat',width:'100%'}} className='p-5'>
        ...
        <div className="modal fade" id="UpdateMyInfo">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div>
                            <img src="https://res.cloudinary.com/dljwo91tl/image/upload/v1712679595/samples/coffee.jpg" alt="backgroundURL" id='backgroundURL' />
                        </div>
        ...
        <div className="modal fade" id="SignoutModal">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div>
                            <img src="https://res.cloudinary.com/dljwo91tl/image/upload/v1712679595/samples/coffee.jpg" alt="backgroundURL" id='backgroundURL' width='100%' />
                        </div>
                        <div className='text-center' style={{marginTop:'-35px'}}>
                            ...
                            <div className="form-check text-start">
                                ...
                                <label className="form-check-label" htmlFor="nonbackup">Đăng xuất và không lưu cho lần đăng nhập sau.</label>
                            </div>
                            <div className="form-check text-start">
                                <input type="radio" className="form-check-input" id="backup" name="selectBackupType" value="backup" />
                                <label className="form-check-label" htmlFor="backup">Sao lưu cho lần đăng nhập sau (Đăng xuất chậm sao lưu, load nhanh cho lần dùng sau).</label>
                            </div>
                        </div>
                    </div>
                    <div className="modal-footer">
